...
export enum EstadoLibroDevuelto {
    DEVUELTO_BUENO = 1,   // Devuelto en buen estado sin importar si está atrasado o no
    PERDIDO_TOTAL = 2     // Perdido, dañado, roto, mojado... etc 
}
@Entity('multas')
export class MultaEntity {
  ...
  @Column({ name: 'estado_pago', type: 'smallint', enum: EstadoPagoMulta, default: EstadoPagoMulta.PENDIENTE })
