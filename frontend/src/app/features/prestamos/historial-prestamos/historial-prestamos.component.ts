  ...
  prestamos: Prestamo[] = [
    {
      id: 1,
      tipo: 'prestamo',
      fechaRetiro: new Date('2026-05-01'),
      fechaDevolucion: new Date('2026-05-15'),
      estado: 'finalizado',
    },
    {
      id: 2,
      tipo: 'reserva',
      fechaRetiro: new Date('2026-06-10'),
      fechaDevolucion: new Date('2026-06-20'),
      estado: 'activo',
    },
    {
      id: 3,
      tipo: 'prestamo',
      fechaRetiro: new Date('2026-04-10'),
      fechaDevolucion: new Date('2026-04-20'),
      estado: 'finalizado',
    },
    {
      id: 4,
      tipo: 'reserva',
      fechaRetiro: new Date('2026-07-01'),
      fechaDevolucion: new Date('2026-07-10'),
      estado: 'activo',
    },
    {
      id: 5,
      tipo: 'prestamo',
      fechaRetiro: new Date('2026-08-01'),
