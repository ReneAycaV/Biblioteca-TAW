...
export class HorarioComponent implements OnInit {
  ...
  seleccionActual: { dia: string, idBloque: string, rango?: string } | null = null;
  ...
  esSeleccionado(dia: string, idBloque: string): boolean {
    return this.seleccionActual?.dia === dia && this.seleccionActual?.idBloque === idBloque;
  }
...
// 1. Filtros
  ...
  allSalas = [
    { idSala: 1, nombreSala: 'Sala 1-A', capacidad: 6, ubicacion: 'Aulario A', tipo: 'Estudio' },
    { idSala: 2, nombreSala: 'Sala 3-A', capacidad: 4, ubicacion: 'Aulario A', tipo: 'Estudio' },
    { idSala: 3, nombreSala: 'Sala 1-C', capacidad: 8, ubicacion: 'Aulario C', tipo: 'Estudio' },
    { idSala: 4, nombreSala: 'Auditorio Principal', capacidad: 50, ubicacion: 'Auditorio', tipo: 'Auditorio' },
    { idSala: 5, nombreSala: 'Auditorio Secundario', capacidad: 30, ubicacion: 'Auditorio', tipo: 'Auditorio' }
  ];
